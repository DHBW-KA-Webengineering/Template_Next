...
- Because of the _Template_Next_ path in the URL, `Template_Next` is required in line 8 of the [package.json file](package.json) file￼. If you deploy the repository to a different URL (e.g., if you choose a different name for your repo), you will need to adapt or remove this part.
