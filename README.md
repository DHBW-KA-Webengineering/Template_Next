...
After Forking, deploy works automatically with each push to github pages. The template is deployed to [dhbw-ka-webengineering.github.io/Template_Next/](https://dhbw-ka-webengineering.github.io/Template_Next/)
